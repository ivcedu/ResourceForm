...
//        deadlinePastNotification();
    ...
    $(document).on('click', 'button[id^="btn_restart_RF_"]', function() {
        ...
        var mod_restart_body = "Are you sure you want to restart (" + ptitle_full + ") for Submission Year: ";
        mod_restart_body += getFiscalYear() + "? Click Yes to continue or No to cancel. If Yes, ";
        mod_restart_body += "you can find your request in the Submission Year: " + getFiscalYear() + " listed on the home screen.";
...
function setAdminOption() {        
    ...
    if (ApproverID !== null || LoginEmail === "ykim160@ivc.edu" || LoginEmail === "jcalderin@ivc.edu" || LoginEmail === "mfeoktistova@ivc.edu") {
        $('#show_admin').show();
        if (LoginEmail === "ykim160@ivc.edu" || LoginEmail === "bhagan@ivc.edu" || LoginEmail === "dkhachatryan@ivc.edu" || LoginEmail === "jcalderin@ivc.edu" || LoginEmail === "mfeoktistova@ivc.edu") {
            $('#rpt_master').show();
            if (LoginEmail === "ykim160@ivc.edu" || LoginEmail === "bhagan@ivc.edu" || LoginEmail === "jcalderin@ivc.edu" || LoginEmail === "mfeoktistova@ivc.edu") {
                $('#show_master').show();
            }
        }
    }
