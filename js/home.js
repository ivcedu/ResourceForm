...
function setAdminOption() {        
    ...
    if (ApproverID !== null || LoginEmail === "ykim160@ivc.edu" || LoginEmail === "aturner@ivc.edu") {
        $('#show_admin').show();
        if (LoginEmail === "ykim160@ivc.edu" || LoginEmail === "bhagan@ivc.edu" || LoginEmail === "dkhachatryan@ivc.edu" || LoginEmail === "aturner@ivc.edu") {
            $('#rpt_master').show();
            if (LoginEmail === "ykim160@ivc.edu" || LoginEmail === "bhagan@ivc.edu" || LoginEmail === "aturner@ivc.edu") {
                $('#show_master').show();
            }
        }
    }
