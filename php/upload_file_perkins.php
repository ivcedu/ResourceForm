<?php
    ...
    {    
        ...
        $ResourceID = str_replace("perkins_", "", $ResourceID);
        ...
        $PerkinsAttachID = insertAttachToDB($dbConn, $ResourceID, $upload_file_link, $file_name);

        echo json_encode($PerkinsAttachID); 
    }
    
    function insertAttachToDB($dbConn, $ResourceID, $FileLinkName, $FileName) {        
        $ResultID = "";
        $query = "INSERT INTO [IVCRESOURCES].[dbo].[PerkinsAttach] "
