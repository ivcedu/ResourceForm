<?php
    ...
    if (isset($_POST['LoginEmail']))
    {
        ...
        $query = "SELECT resr.ResourceID, "
                    ...
                    ."stlv.StageLevel, "
                    ."rsst.ResourceStatus, "
                    ."(SELECT TOP(1) GrandTotal FROM [IVCRESOURCES].[dbo].[Technology] WHERE ResourceID = resr.ResourceID ORDER BY TechnologyID DESC) AS TotalAmount, "
                    ."crtr.CreatorName, "
                    ."resr.ApprovalID "
                    ...
                    ."WHERE stlv.StageLevel = 'IT Review' ".$sql_approver;
